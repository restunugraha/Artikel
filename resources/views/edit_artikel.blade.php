...
<body>
  <div class="ui container">
    ...
    <form method="post" action="{{route('artikel.update',$edit->id)}}" class="ui form" enctype="multipart/form-data">
        {{csrf_field()}}
        <input type="hidden" name="_method" value="patch">
          ...
          <div class="field">
            ...
            <div class="two fields">
              <div class="field">
                ...
                <input name="Judul" placeholder="Judul Artikel" type="text" value="{{$edit->judul_artikel}}">
              </div>

              <div class="field">
                <label>Slug</label>
                <input name="slug" placeholder="slug" type="text" value="{{$edit->slug}}">
              </div>
         ...
         <div class="field">
            <div class="two fields">
               ...
               <div class="field">
                    <label>Kutipan</label>
                    <input name="kutipan" placeholder="Kutipan" type="text" value="{{$edit->kutipan}}">
                </div>
            </div>
         </div>
        ...
        <div class="field">
            <div class="two fields">
                ...
                <div class="ui action input icon">
                      ...
                      <input type="hidden" name="fotoup" value="{{$edit->foto}}">
        ...
        <div class="field"></div>
            <label>Artikel</label>
            <textarea class="artikel" name="artikel">{!!$edit->isi!!}</textarea>
